        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
          <div className="min-w-0">
            ...
            <div className="prose-nen">
              ...
              <ul>
                <li>
                  <strong>Гарсониера или багаж</strong> — 2 хамали за 2 часа
                  (50 €) + мини ван за 2 часа (60 €) ≈{" "}
                  <strong>110 €</strong>
                </li>
                <li>
                  <strong>Двустаен апартамент</strong> — 2 хамали за 3 часа
                  (75 €) + микробус 14 м³ за 3 часа (120 €) ≈{" "}
                  <strong>195 €</strong>
                </li>
                <li>
                  <strong>Тристаен или къща</strong> — 3 хамали за 4 часа
                  (150 €) + камион 20 м³, 2 курса (140 €) ≈{" "}
                  <strong>290 €</strong>
                </li>
              </ul>
              <p>
                Часовете зависят от етажа, асансьора и колко е опакован
                багажът — затова примерите са ориентир, а офертата ти е
                конкретна.
              </p>
            </div>

            <h2 className="text-2xl mt-10 mb-3">Без скрити такси</h2>
            <div className="prose-nen">
              <ul>
                <li>
                  <strong>Фолирането на мебелите е безплатно</strong> — част е
                  от услугата, не допълнителен ред във фактурата.
                </li>
                <li>
                  <strong>Етаж, асансьор и паркиране уточняваме
                  предварително</strong> — преди екипът да тръгне, не на
                  място.
                </li>
                <li>
                  <strong>Кашоните и опаковъчните материали се договарят
                  отделно</strong> — казваме цената им заедно с офертата.
                </li>
              </ul>
              <p className="text-sm text-secondary">
                Цените на тази страница са официалните ни тарифи, актуални към
                юли 2026 г.
              </p>
            </div>
