...
export const metadata: Metadata = {
  title: "Хамали София — преместване от 110 €, цени 2026 | Ненчовски",
  description:
    "Хамалски услуги в София от Хамали Ненчовски: преместване от 110 €, кърти-чисти-извозва, почистване. 18 години опит, оферта до 1 час. ☎ 0894 766 424",
...
const HOME_FAQ = [
  {
    ...
    a: "Преместване на дом е ориентировъчно от 110 € (гарсониера), двустаен 195–300 €, тристаен или къща 290 €. Отделните услуги имат пакетни цени — превоз на диван от 120 €, пиано от 150 €, офис от 250 €. Ако предпочитате, работим и почасово: хамалин 12,50 €/ч, мини ван 30 €/ч, микробус 40 €/ч, камион 60 €/курс. Точната цена потвърждаваме при безплатен оглед или по телефона.",
  },
  {
