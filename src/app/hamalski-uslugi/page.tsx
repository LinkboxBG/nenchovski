...
export const metadata: Metadata = {
  title: "Хамалски услуги София — цени 2026 от 12,50 €/ч | Ненчовски",
  description:
    "Хамалски услуги в София, страната и чужбина: преместване, кърти-чисти-извозва, почистване, транспорт. Цени от 12,50 €/ч, без скрити такси, оферта до 1 час. ☎ 0894 766 424",
  alternates: { canonical: `${SITE.domain}${URL_PATH}` },
  openGraph: {
    title: "Хамалски услуги София — цени 2026 | Хамали Ненчовски",
    description:
      "Всички хамалски услуги на едно място: преместване, кърти-чисти-извозва, почистване и транспорт. Хамалин от 12,50 €/ч, оферта до 1 час — 0894 766 424.",
...
const PRICE_CATEGORIES = [
  {
    ...
    lines: [
      "Хамалин — 12,50 €/ч в София, 15 €/ч за страната",
      "Фолиране и обезопасяване на мебелите — безплатно",
      "Разглобяване и сглобяване на мебели — с предупреждение",
    ],
  ...
  },
  {
    ...
    lines: [
      "Работник — 12,50 €/ч + транспорт до лицензирано депо",
      "Микробус 40 €/ч или камион 60 €/курс за извозването",
      "Крайна цена след безплатен оглед или снимки",
    ],
  ...
  },
  {
    ...
    lines: [
      "Работник — 12,50 €/ч + извозване според обема",
  ...
  },
  {
    ...
    href: "/bus-pod-naem/",
    lines: [
      "Мини ван (2 м³) — 30 €/ч · Микробус (14 м³) — 40 €/ч",
      "Камион (20 м³) — 60 €/курс + 10 € престой",
...
const PILLAR_FAQ = [
  {
    ...
    a: "Ставката за хамалин е 12,50 €/ч за София. Транспортът се таксува отделно: мини ван 30 €/ч, микробус 40 €/ч, а камион — 60 €/курс. Крайната цена зависи от обема работа, етажа и достъпа, затова изготвяме индивидуална оферта след безплатна консултация.",
  },
  {
  ...
  },
  {
    ...
    a: "Да — услугата бус под наем с шофьор започва от 30 €/ч за мини ван. Шофьорът кара и помага при товаренето, а ако по средата решите, че ви трябват още ръце, изпращаме хамали допълнително.",
  },
  {
  ...
  return (
    <>
      ...
      <Hero
        ...
        subtitle="Преместване, кърти-чисти-извозва, почистване и транспорт от Хамали Ненчовски — 18 години опит (от 2008 г.). Хамалин от 12,50 €/ч, без скрити такси, оферта до 1 час в работно време."
        image={{
      ...
      <section id="ceni" aria-labelledby="ceni-h" className="scroll-mt-44 bg-paper">
        <div className="mx-auto max-w-[1140px] px-4 py-14 md:py-20">
          ...
          <p data-reveal className="mt-5 max-w-3xl text-[17px] leading-relaxed">
            Ставките ни са едни и същи за всеки клиент — не различаваме цена
            според това дали местите апартамент под наем или собствен дом, нито
            дали сте домакинство или фирма. Разликата в крайната сметка идва
            единствено от обема работа, не от това кой пита. Това са официалните
            ни тарифи, актуални към юли 2026 г. — без скрити такси.
          </p>
          ...
          <div>
            ...
            <div className="prose-nen mt-5">
              ...
              <p>
                ...
                <Link href="/bus-pod-naem/">бус под наем с шофьор</Link> от 30
                €/ч решава въпроса.
              </p>
            </div>
          </div>
